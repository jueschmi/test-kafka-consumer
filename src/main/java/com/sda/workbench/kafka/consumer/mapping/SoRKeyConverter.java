...
public class SoRKeyConverter extends BidirectionalConverter<com.sda.workbench.kafka.consumer.document.rest.model.SoRKey, SoRKey> {
    @Override
    public SoRKey convertTo(com.sda.workbench.kafka.consumer.document.rest.model.SoRKey source, Type<SoRKey> destinationType, MappingContext mappingContext) {
        if (source != null) {
    ...
    @Override
    public com.sda.workbench.kafka.consumer.document.rest.model.SoRKey convertFrom(SoRKey source, Type<com.sda.workbench.kafka.consumer.document.rest.model.SoRKey> destinationType, MappingContext mappingContext) {
        if (source != null) {
