...
public class TestKafkaConsumerApplication extends Application<AppConfiguration> {
  ...
  private static KafkaBundle<AppConfiguration> kafkaBundle = new KafkaBundle<>(
      AppConfiguration::getKafka);
  ...
  public void run(final AppConfiguration configuration, final Environment environment)
    ...
    kafkaBundle.registerAvroMessageHandler(configuration.getTopics().testEventTopic,
